				...
				<ul class="navbar-nav ms-md-auto justify-content-end">
					...
					<li class="nav-item dropdown pe-2 d-flex align-items-center">
						<a href="javascript:;" class="nav-link text-body p-0" id="dropdownMenuButton" data-bs-toggle="dropdown" aria-expanded="false">
							<span class="text-secondary font-weight-bold d-xl-inline d-none">{{ $page.props.user.nombres_usuario }} {{ $page.props.user.apellidos_usuario }}</span>
						...
						<ul class="dropdown-menu dropdown-menu-end px-2 py-2 me-sm-n4" aria-labelledby="dropdownMenuButton">
							<li class="mb-0">
								<form @submit.prevent="logout">
	                                <Link class="dropdown-item border-radius-md" href="#" v-on:click="logout">
